...
def build_get_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.DeviceRegistry/locations/{location}/operationStatuses/{operationId}")  # pylint: disable=line-too-long
...
class OperationStatusOperations:
    ...
    def get(
        ...
        **kwargs: Any
        ...
        :rtype: ~deviceregistry.mgmt.models.OperationStatusResult
    ...
    get.metadata = {'url': "/subscriptions/{subscriptionId}/providers/Microsoft.DeviceRegistry/locations/{location}/operationStatuses/{operationId}"}  # type: ignore
