...
class DeviceRegistryUpdateClientConfiguration:  # pylint: disable=too-many-instance-attributes
    """Configuration for DeviceRegistryUpdateClient.
    ...
    def __init__(self, credential: "AsyncTokenCredential", **kwargs: Any) -> None:
        ...
        kwargs.setdefault("sdk_moniker", "azext-iot-sdk-deviceupdate-duregistrydata/{}".format(VERSION))
