...
"""
ADR CMS (Certificate Management Service) integration tests.
...
class TestADRCmsLifecycle(CaptureOutputLiveScenarioTest):
    """End-to-end certificate authority + certificate policy lifecycle through the CLI."""

    def test_adr_cms_lifecycle(self):
        _log(LogKind.TEST, "test_adr_cms_lifecycle")
        rg = TEST_RG
